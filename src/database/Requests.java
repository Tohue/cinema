...
public class Requests {
    ...
    public static final String GET_NEAR_FILMS = "SELECT select FilmName FROM Sessions INNER JOIN Films on Sessions.FilmName = Films.Name WHERE SessionDate >= CURRENT_DATE;";
